...
struct BSData {
    ...
    var objects0100: Results<DataBaseSettingsTaxonomy> // 流動資産
             // MARK: - "    流動資産合計"
    var CurrentAssets_total: String
    var lastCurrentAssets_total: String
             // MARK: - "  固定資産"
    // 小区分 // MARK: - 有形固定資産3
    ...
    var objects0102: Results<DataBaseSettingsTaxonomy> // 繰延資産
             // MARK: - "    繰越資産合計"
    var DeferredAssets_total: String
    var lastDeferredAssets_total: String
             // MARK: - "資産合計"
    var Asset_total: String
    var lastAsset_total: String

    // 大区分 // MARK: - 負債の部
    // 中区分 // MARK: - "  流動負債"
    var objects0114: Results<DataBaseSettingsTaxonomy> // 流動負債
             // MARK: - "    流動負債合計"
    var CurrentLiabilities_total: String
    var lastCurrentLiabilities_total: String
             // MARK: - "  固定負債"
    var objects0115: Results<DataBaseSettingsTaxonomy> // 固定負債
             // MARK: - "    固定負債合計"
    var FixedLiabilities_total: String
    var lastFixedLiabilities_total: String
             // MARK: - "負債合計"
    var Liability_total: String
    var lastLiability_total: String
    ...
    var lastEquity_total: String
             // MARK: - "負債純資産合計"
    var Liability_and_Equity_total: String
    var lastLiability_and_Equity_total: String
}
