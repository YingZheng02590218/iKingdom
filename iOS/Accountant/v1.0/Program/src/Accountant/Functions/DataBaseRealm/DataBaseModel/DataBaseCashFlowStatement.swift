...
class DataBaseCashFlowStatement: RObject {
    convenience init(
        ...
        EffectOfExchangeRateChangesOnCashAndCashEquivalents: Int,
        NetIncreaseInCashAndCashEquivalents: Int,
        CashAndCashEquivalentsAtBeginningOfPeriod: Int,
        CashAndCashEquivalentsAtEndOfPeriod: Int
    ) {
        self.init()

        self.fiscalYear = fiscalYear

        self.CashFlowsFromOperatingActivities = CashFlowsFromOperatingActivities
        self.CashFlowsFromInvestingActivities = CashFlowsFromInvestingActivities
        self.CashFlowsFromfInancingActivities = CashFlowsFromfInancingActivities
        self.EffectOfExchangeRateChangesOnCashAndCashEquivalents = EffectOfExchangeRateChangesOnCashAndCashEquivalents
        self.NetIncreaseInCashAndCashEquivalents = NetIncreaseInCashAndCashEquivalents
        self.CashAndCashEquivalentsAtBeginningOfPeriod = CashAndCashEquivalentsAtBeginningOfPeriod
        self.CashAndCashEquivalentsAtEndOfPeriod = CashAndCashEquivalentsAtEndOfPeriod
    }
