...
//            addAccount = false // 新規追加後にフラグを倒す
            ...
            if let settingsCategoryDetailTableViewController: SettingsCategoryDetailTableViewController = self.presentingViewController as? SettingsCategoryDetailTableViewController {
