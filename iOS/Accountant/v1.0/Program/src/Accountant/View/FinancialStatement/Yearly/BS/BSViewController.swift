...
extension BSViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        35 // セクションヘッダーの高さを設定　セルの高さより高くしてメリハリをつける セル(Row Hight 30)
    }
    // セクションヘッダーの色とか調整する
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case 2:// 純資産の部
            ...
            presenter.numberOfobjects01210 +
            presenter.numberOfobjects01211 +
            presenter.numberOfobjects01213 + 1 // +1 は、負債純資産合計　の分
        default:
            print("default")
            return 0
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.labelForThisYear.textColor = .paperTextColor
        cell.labelForPrevious.textColor = .paperTextColor
        ...
        case 0: // MARK: - 資産の部
            ...
            case presenter.numberOfobjects0100 + 1 + 1 + 1: // 112
                cell.textLabel?.text = "        " + translateSmallCategory(smallCategory: 3)
                print("BS", indexPath.row, "        " + translateSmallCategory(smallCategory: 3) + "★")
                cell.textLabel?.font = UIFont.systemFont(ofSize: 15)
                return cell
                // MARK: - 無形固定資産
            case presenter.numberOfobjects0100 + 1 + 1 + 1 + presenter.numberOfobjects010142 + 1:
                cell.textLabel?.text = "        " + translateSmallCategory(smallCategory: 4)
                print("BS", indexPath.row, "        " + translateSmallCategory(smallCategory: 4) + "★")
                cell.textLabel?.font = UIFont.systemFont(ofSize: 15)
                return cell
            ...
            case presenter.numberOfobjects0100 + 1 + 1 + 1 + presenter.numberOfobjects010142 + 1 + presenter.numberOfobjects010143 + 1:
                cell.textLabel?.text = "        " + translateSmallCategory(smallCategory: 5)
                print("BS", indexPath.row, "        " + translateSmallCategory(smallCategory: 5) + "★")
                cell.textLabel?.font = UIFont.systemFont(ofSize: 15)
                return cell
            ...
            default:
                ...
                if       indexPath.row >= 1 &&                           // 流動資産タイトルの1行下 中区分タイトルより下の行から、中区分合計の行より上
                    ...
                    cell.textLabel?.text = "        " + presenter.objects010142(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 + 1)
                    ).category
                    print("BS", indexPath.row, "        " + presenter.objects010142(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 + 1)
                    ).category)
                    cell.labelForThisYear.text = presenter.getTotalOfTaxonomy(
                        numberOfSettingsTaxonomy: presenter.objects010142(
                            forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 + 1)
                        ).number,
                        lastYear: false
                    )
                    ...
                    cell.labelForThisYear.textAlignment = .right
                            ...
                            indexPath.row < presenter.numberOfobjects0100 + 1 + 1 + 1 +
                            presenter.numberOfobjects010142 + 1 + presenter.numberOfobjects010143 + 1 { // 投資その他資産
                    cell.textLabel?.text = "        " + presenter.objects010143(forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 +
                                                                                                         presenter.numberOfobjects010142 + 1 + 1)).category
                    print("BS", indexPath.row, "        " + presenter.objects010143(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 +
                                                 presenter.numberOfobjects010142 + 1 + 1)
                    ).category)
                    cell.labelForThisYear.text = presenter.getTotalOfTaxonomy(
                        numberOfSettingsTaxonomy: presenter.objects010143(
                            forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 + presenter.numberOfobjects010142 + 1 + 1)
                        ).number,
                        lastYear: false
                    )
                    if presenter.checkSettingsPeriod() { // 前年度の会計帳簿の存在有無を確認
                ...
                } else if indexPath.row >= presenter.numberOfobjects0100 + 1 + 1 + 1 +
                            presenter.numberOfobjects010142 + 1 + presenter.numberOfobjects010143 + 1 + 1 && // 投資その他資産タイトルの1行下
                            indexPath.row < presenter.numberOfobjects0100 + 1 + 1 +
                            presenter.numberOfobjects010142 + 1 +
                            presenter.numberOfobjects010143 + 1 +
                            presenter.numberOfobjects010144 + 1 + 1 { // 固定資産合計
                    cell.textLabel?.text = "        " + presenter.objects010144(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 +
                                                 presenter.numberOfobjects010142 + 1 +
                                                 presenter.numberOfobjects010143 + 1 + 1)
                    ).category
                    print("BS", indexPath.row, "        " + presenter.objects010144(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 + 1 +
                                                 presenter.numberOfobjects010142 + 1 +
                                                 presenter.numberOfobjects010143 + 1 + 1)
                    ).category)
                    ...
                    cell.labelForThisYear.textAlignment = .right
                } else if indexPath.row >= presenter.numberOfobjects0100 + 1 + 1 +
                            presenter.numberOfobjects010142 + 1 +
                            presenter.numberOfobjects010143 + 1 +
                            presenter.numberOfobjects010144 + 1 + 1 + 1 + 1 && // 繰延資産タイトルの1行下
                            indexPath.row < presenter.numberOfobjects0100 + 1 + 1 +
                            presenter.numberOfobjects010142 + 1 +
                            presenter.numberOfobjects010143 + 1 +
                            presenter.numberOfobjects010144 + 1 + 1 + 1 +
                            presenter.numberOfobjects0102 + 1 { // 繰延資産合計
                    cell.textLabel?.text = "        " + presenter.objects0102(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 +
                                                 presenter.numberOfobjects010142 + 1 +
                                                 presenter.numberOfobjects010143 + 1 +
                                                 presenter.numberOfobjects010144 + 1 + 1 + 1 + 1)
                    ).category
                    print("BS", indexPath.row, "        " + presenter.objects0102(
                        forRow: indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 +
                                                 presenter.numberOfobjects010142 + 1 +
                                                 presenter.numberOfobjects010143 + 1 +
                                                 presenter.numberOfobjects010144 + 1 + 1 + 1 + 1)
                    ...
                    cell.labelForThisYear.text = presenter.getTotalOfTaxonomy(
                        numberOfSettingsTaxonomy: presenter.objects0102(forRow:
                                                                            indexPath.row - (presenter.numberOfobjects0100 + 1 + 1 +
                                                                                             presenter.numberOfobjects010142 + 1 +
                                                                                             presenter.numberOfobjects010143 + 1 +
                                                                                             presenter.numberOfobjects010144 + 1 + 1 + 1 + 1)).number,
                        lastYear: false
                    )
                    if presenter.checkSettingsPeriod() { // 前年度の会計帳簿の存在有無を確認
                        cell.labelForPrevious.text = presenter.getTotalOfTaxonomy(
