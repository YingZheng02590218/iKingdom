...
class DataBaseAccount: RObject {
    ...
    @objc dynamic var credit_total_Adjusting: Int64 = 0          //貸方合計
    @objc dynamic var debit_balance_Adjusting: Int64 = 0         //借方残高
    @objc dynamic var credit_balance_Adjusting: Int64 = 0        //貸方残高
    //決算整理後
    @objc dynamic var debit_total_AfterAdjusting: Int64 = 0           //借方合計
    @objc dynamic var credit_total_AfterAdjusting: Int64 = 0          //貸方合計
    @objc dynamic var debit_balance_AfterAdjusting: Int64 = 0         //借方残高
    @objc dynamic var credit_balance_AfterAdjusting: Int64 = 0        //貸方残高
}
